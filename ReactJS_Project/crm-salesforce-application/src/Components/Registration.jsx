        ...
        <div style={{ marginTop: '30px' }}>
            ...
            <div className='registration'>
                ...
                <FormControl>
                    ...
                    <TextField className='textField' label="Contact Number" type='number' variant='outlined' value={registrationUser.contactNumber} name='contactNumber' onChange={handleChange} error={passwordMatchError !== ''} helperText={passwordMatchError} />
